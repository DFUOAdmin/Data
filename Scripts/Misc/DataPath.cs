...
namespace Server.Misc
{
	public class DataPath
	{
		 ...
		 * Example:
		 *  private static string CustomPath = @"C:\Users\Administrator\Desktop\DarkFactionsFullRepo\trunk\Shard\MapData";
		 */
		private static string CustomPath = @"..\\9thAni\Ultima Online 2D Client";
