...
{
    [CorpseName ( "a guardian dread horn corpse" )]
    public class GuardianDreadHorn : DreadHornEvo , IEvoGuardian
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

		[Constructable]
        public GuardianDreadHorn ( ) : base ( "A Guardian Dread Horn" )
		{
		}

		public GuardianDreadHorn( Serial serial ) : base( serial )
		{
		}
		...
		public override void GenerateLoot()
		{
			...
			{
                DreadHornEvoBaseEgg egg = GetEvoEgg ();
