...
{
    public sealed class DreadHornEvoSpec : BaseEvoSpec
	{
		...
		DreadHornEvoSpec()
		{
			...
			m_MaxTrainingStage = 3; ///Stat Training ???????
			m_MountStage = 5;
            ...
            m_Stages = new BaseEvoStage [] { new DreadHornStageOne(), new DreadHornStageTwo(), new DreadHornStageThree(),
											  new DreadHornStageFour(), new DreadHornStageFive() };
		}
        ...
        public static DreadHornEvoSpec Instance { get { return Nested.instance; } }
        class Nested { static Nested ( ) { } internal static readonly DreadHornEvoSpec instance = new DreadHornEvoSpec ();}
	}	
    ...
    public class DreadHornStageOne : BaseEvoStage
	{
		public DreadHornStageOne()
		{
	...
	public class DreadHornStageTwo : BaseEvoStage
	{
		public DreadHornStageTwo()
		{
			EvolutionMessage = "has evolved";
	...
	public class DreadHornStageThree : BaseEvoStage
	{
		public DreadHornStageThree()
		{
			EvolutionMessage = "has evolved";
	...
	public class DreadHornStageFour : BaseEvoStage
	{
		public DreadHornStageFour()
		{
			EvolutionMessage = "has evolved";
	...
	public class DreadHornStageFive : BaseEvoStage
	{
		public DreadHornStageFive()
		{
			Title = "The Ancient Dread Horn";
            EvolutionMessage = "has evolved to its highest form and is now an Ancient Dread Horn";
			NextEpThreshold = 0; EpMinDivisor = 160; EpMaxDivisor = 40; DustMultiplier = 20;
			BaseSoundID = 362; ControlSlots = 4;
			BodyValue = 0x101; VirtualArmor = 100;
