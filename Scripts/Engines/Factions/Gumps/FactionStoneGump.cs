...
namespace Server.Factions
{
	public class FactionStoneGump : FactionGump
	{
		...
		public FactionStoneGump( PlayerMobile from, Faction faction ) : base( 20, 30 )
		{
			...
			AddBackground( 0, 0, 550, 600, 5054 );
			AddBackground( 10, 10, 530, 570, 3000 );
			...
			AddImage( 20, 510, 2361 );
			AddHtmlLocalized( 45, 510, 450, 20, 1011491, false, false ); // sigil may be recaptured

			AddImage( 20, 530, 2360 );
			AddHtmlLocalized( 45, 530, 470, 20, 1011492, false, false ); // sigil may not be recaptured

			AddHtmlLocalized( 55, 550, 550, 20, 1011447, false, false ); // BACK
			AddButton( 20, 550, 4005, 4007, 0, GumpButtonType.Page, 1 );
			#endregion
