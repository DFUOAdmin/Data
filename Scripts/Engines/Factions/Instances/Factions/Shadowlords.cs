				...
				new FactionDefinition(
					...
					new StrongholdDefinition(
						...
						new Point3D[]
						{
                            ...
                            new Point3D( 949, 709, 20 ),
                            new Point3D( 949, 705, 20 ),
                            new Point3D( 949, 701, 20 ),
                            new Point3D( 961, 701, 20 ),
                            new Point3D( 961, 705, 20 ),
                            new Point3D( 961, 709, 20 ),
                            new Point3D( 949, 713, 20 ) 
						} ),
					new RankDefinition[]
					{
