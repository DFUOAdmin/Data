				...
				new FactionDefinition(
					...
					new StrongholdDefinition(
						...
						new Point3D[]
						{
                            ...
                            new Point3D( 1116, 2604, 18 ),
                            new Point3D( 1116, 2607, 18 ),
                            new Point3D( 1113, 2607, 18 ),
                            new Point3D( 1116, 2589, 18 ),
                            new Point3D( 1113, 2589, 18 ),
                            new Point3D( 1113, 2586, 18 ),
                            new Point3D( 1113, 2604, 18 ) 
                        } ),
					new RankDefinition[]
					{
