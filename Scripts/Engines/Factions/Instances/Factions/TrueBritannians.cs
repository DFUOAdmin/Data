				...
				new FactionDefinition(
					...
					new StrongholdDefinition(
						...
						new Point3D[]
						{
                            ...
                            new Point3D( 1337, 1621, 50 ), 
                            new Point3D( 1337, 1627, 50 ), 
                            new Point3D( 1330, 1627, 50 ), 
                            new Point3D( 1332, 1627, 50 ), 
                            new Point3D( 1332, 1621, 50 ), 
                            new Point3D( 1342, 1627, 50 ), 
                            new Point3D( 1342, 1621, 50 ) 
                        } ),
					new RankDefinition[]
					{
