				...
				new FactionDefinition(
					...
					new StrongholdDefinition(
						...
						new Point3D[]
						{
                            ...
                            new Point3D( 3788, 2257, 20 ),
                            new Point3D( 3785, 2257, 20 ),
                            new Point3D( 3782, 2257, 20 ),
                            new Point3D( 3792, 2261, 20 ),
                            new Point3D( 3788, 2261, 20 ),
                            new Point3D( 3785, 2261, 20 ),
                            new Point3D( 3791, 2257, 20 )
                        } ),
					new RankDefinition[]
					{
