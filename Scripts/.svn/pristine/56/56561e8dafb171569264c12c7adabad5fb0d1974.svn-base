...
{
    public abstract class DragonEvoBaseEgg : Item
    {
        ...
        // Define as concrete in your subclass and return an instance of your DragonEvoBase subclass there
        public abstract IEvoCreature GetEvoCreature ( );

        public DragonEvoBaseEgg ( ) : base ( 0xC5C )    // eggs ItemID = 2485 (0x9B5)  water melon Now
        {
            Weight = 20.0;
            Name = "an evolution egg";
            Hue = 1;
            m_HatchDuration = 0.01;    // 15 minutes      1.00 is 1 hour
            m_AllowEvolution = false;
            m_Start = DateTime.Now;
        }

        public DragonEvoBaseEgg ( Serial serial )
            : base ( serial )
        {
        }
