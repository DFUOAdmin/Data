...
namespace Xanthos.Evo
{
	...
	public abstract class DreadHornEvoBase : BaseMount, IEvoCreature
	{
        ...
        public abstract DreadHornEvoBaseEgg GetEvoEgg();
		...
		public DreadHornEvoBase( string name, int bodyID, int itemID ) : base( name, bodyID, itemID, AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = name;
			Init();
			InitAI();
        ...
        public DreadHornEvoBase ( Serial serial ) : base ( serial )
		{
		}
		...
		{
            DragonEvoBase evo = obj as DragonEvoBase;
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write ( ( int ) 0 );  //writer.Write( (int)2 );
