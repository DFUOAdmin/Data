...
namespace Xanthos.Evo
{
    ...
    public abstract class DragonEvoBase : BaseCreature , IEvoCreature
    {
        ...
        public abstract DragonEvoBaseEgg GetEvoEgg ( );
        ...
        public DragonEvoBase ( string name , AIType ai , double dActiveSpeed )
            : base ( ai , FightMode.Closest , 10 , 1 , dActiveSpeed , 0.4 )
        {
            Name = name;
            Init ();
            InitAI ();
        ...
        public DragonEvoBase ( Serial serial )
            : base ( serial )
        {
            InitAI ();
        }
    ...
    public class PregnancyTimer : Timer
    {
        ...
        public PregnancyTimer ( IEvoCreature female )
            : base ( female.RemainingTerm )
        {
