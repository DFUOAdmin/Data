		...
		private static CityInfo[] StartingCities = new CityInfo[]
			{
				...
				new CityInfo( "Yew",		"The Empath Abbey",	1075073, 633,	858,	0  ),
				new CityInfo( "Minoc",		"The Barnacle",		1075072, 2476,	413,	15 ),
                ...
                new CityInfo( "Magincia",   "The Great Horns Tavern", 1075077, 3734, 2222, 20 ),
